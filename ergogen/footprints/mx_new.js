...
module.exports = {
  params: {
    ...
    from: undefined,
    to: undefined,
    switch_3d: "\${KIPRJMOD}/models/mx.step",
    socket_3d: "\${KIPRJMOD}/models/kailh.step",
    cap_3d: "\${KIPRJMOD}/models/dsa.step",
  },
  body: (p) => {
    const model_text = `
      ...
      (model "${p.cap_3d}" (offset (xyz 0 0 11.7)) (scale (xyz 1 1 1)) (rotate (xyz -90 0 0)))
    `;
